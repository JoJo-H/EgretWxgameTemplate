...
server.on('request', (req, res) => {
        ...
        res.write('start publish_fb ...');
        var startime=new Date().getTime();
        this.currentState=true;
        var self=this;
        process_shell.exec('svn up & sh publish_web.sh 1 1',{maxBuffer:10000*1024,cwd:'/home/projects/pocket_hospital_facebook_svn/project'}, (error, stdout)=> {
                if (error) {
