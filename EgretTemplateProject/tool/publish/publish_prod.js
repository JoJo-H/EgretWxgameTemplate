...
server.on('request', (req, res) => {
        ...
        res.write('start publish_prod ...');
        var startime=new Date().getTime();
        this.currentState=true;
        var self=this;
        process_shell.exec('svn up & sh publish_web.sh 1 1',{maxBuffer:10000*1024,cwd:'/home/projects/pocket_hospital_svn/project'}, (error, stdout)=> {
            if (error) {
