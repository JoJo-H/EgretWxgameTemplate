...
export class WxgamePlugin implements plugins.Command {
    ...
    async onFile(file: plugins.File) {
        console.log('WxgamePlugin',file.origin);
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == 'main.js') {
                    content = "var global=window;var egret = window.egret;" + content;
                    content += ";window.Main = Main;"
                }
                else if (filename == 'libs/modules/PathFinding/PathFinding.js'||filename == 'libs/modules/PathFinding/PathFinding.min.js') {
                    content = "var global = window; var egret = window.egret; var PF = window.PF = {};"+content;
                }
                else 
                {
                    content = "var global=window;var egret = window.egret;" + content;
